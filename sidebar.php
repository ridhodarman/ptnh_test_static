...
<body>
  <header class="header" style="position: fixed; margin-top: -80px; z-index: 100; width: 100%;">
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        <div class="navbar-header">
          <!-- Navbar Header--><a href="<?php echo $loc; ?>index.php" class="navbar-brand">
        ...
        <div class="right-menu list-inline no-margin-bottom">
          <div class="list-inline-item"><a href="<?php echo $loc; ?>#" class="search-open nav-link"><i
          ...
          <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com"
            ...
            <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="<?php echo $loc; ?>#"
                ...
                <div class="content"> <strong class="d-block">User</strong><span class="d-block">lorem ipsum dolor sit
                    amit</span><small class="date d-block">9:30am</small></div>
              </a><a href="<?php echo $loc; ?>#" class="dropdown-item message d-flex align-items-center">
                <div class="profile"><img src="<?php echo $loc; ?>img/user.jpg" alt="..." class="img-fluid">
                  <div class="status away"></div>
                </div>
                <div class="content"> <strong class="d-block">User</strong><span class="d-block">lorem ipsum dolor sit
                    amit</span><small class="date d-block">7:40am</small></div>
              </a><a href="<?php echo $loc; ?>#" class="dropdown-item message d-flex align-items-center">
                <div class="profile"><img src="<?php echo $loc; ?>img/user.jpg" alt="..." class="img-fluid">
                  <div class="status busy"></div>
                </div>
                <div class="content"> <strong class="d-block">User</strong><span class="d-block">lorem ipsum dolor sit
                    amit</span><small class="date d-block">6:55am</small></div>
              </a><a href="<?php echo $loc; ?>#" class="dropdown-item message d-flex align-items-center">
                <div class="profile"><img src="<?php echo $loc; ?>img/user.jpg" alt="..." class="img-fluid">
                  <div class="status offline"></div>
                </div>
                <div class="content"> <strong class="d-block">User</strong><span class="d-block">lorem ipsum dolor sit
                    amit</span><small class="date d-block">10:30pm</small></div>
              </a><a href="<?php echo $loc; ?>#" class="dropdown-item text-center message"> <strong>See All Messages <i
          ...
          <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink2" href="http://example.com"
            ...
            <div aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu tasks-list"><a
                href="<?php echo $loc; ?>#" class="dropdown-item">
              ...
              </a><a href="<?php echo $loc; ?>#" class="dropdown-item">
              ...
              </a><a href="<?php echo $loc; ?>#" class="dropdown-item text-center"> <strong>See All Tasks <i
                    class="fa fa-angle-right"></i></strong></a>
            </div>
          </div>
          <!-- Tasks end-->
          <!-- Megamenu-->
          <div class="list-inline-item dropdown menu-large"><a href="<?php echo $loc; ?>#" data-toggle="dropdown"
              class="nav-link">Menu <i class="fa fa-ellipsis-v"></i></a>
            <div class="dropdown-menu megamenu">
              ...
              <div class="row megamenu-buttons text-center">
                <div class="col-lg-2 col-md-4"><a href="<?php echo $loc; ?>#"
                    class="d-block megamenu-button-link dashbg-1"><i class="fa fa-clock-o"></i><strong>Demo
                      1</strong></a></div>
                <div class="col-lg-2 col-md-4"><a href="<?php echo $loc; ?>#"
                    class="d-block megamenu-button-link dashbg-2"><i class="fa fa-clock-o"></i><strong>Demo
                      2</strong></a></div>
                <div class="col-lg-2 col-md-4"><a href="<?php echo $loc; ?>#"
                    class="d-block megamenu-button-link dashbg-3"><i class="fa fa-clock-o"></i><strong>Demo
                      3</strong></a></div>
                <div class="col-lg-2 col-md-4"><a href="<?php echo $loc; ?>#"
                    class="d-block megamenu-button-link dashbg-4"><i class="fa fa-clock-o"></i><strong>Demo
                      4</strong></a></div>
                <div class="col-lg-2 col-md-4"><a href="<?php echo $loc; ?>#"
                    class="d-block megamenu-button-link bg-danger"><i class="fa fa-clock-o"></i><strong>Demo
                      5</strong></a></div>
                <div class="col-lg-2 col-md-4"><a href="<?php echo $loc; ?>#"
          ...
          <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#"
              href="<?php echo $loc; ?>#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
              class="nav-link language dropdown-toggle"><img src="<?php echo $loc; ?>img/flags/16/GB.png"
                alt="English"><span class="d-none d-sm-inline-block">English</span></a>
            <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="<?php echo $loc; ?>#"
                class="dropdown-item"> <img src="<?php echo $loc; ?>img/flags/16/DE.png" alt="English"
                  class="mr-2"><span>German</span></a><a rel="nofollow" href="<?php echo $loc; ?>#"
                class="dropdown-item"> <img src="<?php echo $loc; ?>img/flags/16/FR.png" alt="English"
                  class="mr-2"><span>French </span></a></div>
          </div>
          <!-- Log out               -->
          <div class="list-inline-item logout"> <a id="logout" href="<?php echo $loc; ?>login.html"
              class="nav-link">Logout <i class="icon-logout"></i></a></div>
        </div>
      </div>
    </nav>
  </header>
  <div class="d-flex align-items-stretch" style="margin-top: 80px;">
    <!-- Sidebar Navigation-->
    <nav id="sidebar">
      <!-- Sidebar Header-->
      ...
      <ul class="list-unstyled">
        ...
        <li class="tulisan"><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i
              class="icon-windows"></i>Konsep fenomena fisik dan manusia pada bumi </a>
        ...
        <li class="tulisan"><a href="#dropdown7" aria-expanded="false" data-toggle="collapse">
            <i class="icon-windows"></i>
            Cara kerja sistem komputar secara umum, meliputi pengamanan sistem komputer, pengolahan citra, sejarah
        ...
        <li class="tulisan"><a href="#dropdown15" aria-expanded="false" data-toggle="collapse">
            <i class="icon-windows"></i>
            Pendaftaran tanah: pengumpulan, pengolahan, pembukuan, dan penyajian serta pemeliharaan data fisik dan data
            yuridis
          </a>
        ...
        <li class="tulisan"><a href="#dropdown99" aria-expanded="false" data-toggle="collapse">
          ...
          <ul id="dropdown99" class="collapse list-unstyled ">
            ...
            <li><a href="<?php echo $loc; ?>99campuran/2.php">2</a></li>
          </ul>
        </li>
