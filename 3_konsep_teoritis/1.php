    ...
    <div class="page-header">
        <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Konsep teoritis bidang ilmu manajemen secara umum, manajemen publik,
                organisasi, SDM, dan keuangan: Manajemen Organisasi
            </h2>
        </div>
    </div>
            ...
            <div class="row tulisan">
                ...
                <div class="col-sm-12 card">
                    ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Ilmu perencanaan, pengaturan dan pelaksanaan hubungan antar
                    ...
                    <div>
                        <input id="<?php echo $n ?>B" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>B"> Ilmu dan seni tentang penggunaan sumber daya yang terbatas untuk
                    ...
                    <div>
                        <input id="<?php echo $n ?>C" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>C"> Ilmu untuk mendapatkan hasil kerja yang maksimal dalam rangka
                            pemenuhan kabutuhan organisasi untuk mencapai tujuan misi dan visi perusahaan.
                        </label>
                    </div>
                    <div>
                        <input id="<?php echo $n ?>D" type="radio" name="<?php echo $n ?>"
                    ...
                    <div>
                        <input id="<?php echo $n ?>E" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
                        <label for="<?php echo $n ?>E"> IImu dan seni tentang upaya untuk memanfaatkan semua sumber daya
                            yang dimiliki untuk mencapai tujuan secara efektif dan efisien. </label>
                    </div>
                    <div id="<?php echo $n ?>"></div>
                </div>
                ...
                <div class="col-sm-12 card">
                    ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Planning, Staffing, Reporting, Budgeting, Coordinating,
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Aliran manajemen yang pemikirannya fokus pada usaha untuk mencapai kepuasan
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Studi ilmu manajemen sangat perlukan semua organisasi karena berbagai alasan
                    berikut, kecuali ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Ibu Ayuningtyas mempunyai keahlian dalam merencananakan bentuk kemasan semua
                    produk. Hal tersebut menyebabkan tampilan produk sangat menarik sehingga meningkatkan penjualan
                    produk. Beliau adalah orang yang tepat melakukan aktivitas manajemen di bidang ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Salah satu kegiatan yang dilakukan oleh pimpinan organisasi untuk memotivasi
                    karyawan supaya bekerja keras sesuai dengan tujuan yang telah ditetapkan dan memberikan suasana
                    kerja yang nyaman termasuk dalam fungsi manajemen ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Controlling
                ...
                <div class="col-sm-12 card">
                    ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Adanya tanggung jawab yang sinergi antara masing-masing bagian
                            dalam perusahaan.</label>
                    </div>
                    <div>
                        <input id="<?php echo $n ?>B" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
                    ...
                    <div>
                        <input id="<?php echo $n ?>D" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>D"> Adanya pelimpahan wewenang dari manajemen atas kepada manajemen
                            pelaksana.
                        </label>
                    </div>
                    <div>
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Fungsi manajemen yang pertama kali harus dilakukan untuk menjalankan organisasi
                    secara efektif dan effisien yaitu ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    ...
                    <div>
                        <input id="<?php echo $n ?>C" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>C"> Koordinasi bagi karyawan pada fungsi yang sama mudah karena
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Fungsi manajemen untuk menggerakkan orang agar bekerja sesuai dengan tujuan yang
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Pak Agus berrkedudukan sebagai manajer personalia dan merencanakan perekrutan
                    pegawai baru. Dalam rangka merealisasikan rencananya, beliau melakukan kegiatan-kegiatan mulai dari
                    menetukan panitia, menetapkan tugas, dan tanggung jawab masing-masing individu, serta pelimpahan
                    wewenang kepada bawahan. Aktivitas yang dilakukan oleh Pak Agus sesuai dengan fungsi manajemen,
                    yaitu ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Dalam sistem persediaan pada manajemen produksi penanganan yang terbaik adalah
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Proses indentifikasi sekelompok konsumen yang sifatnya homogen dan akan dilayani
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Menurut pendapat Henry Fayol, jika bawahan mendapat berbagai tugas yang berbeda
                    dari banyak atasan, maka karyawan tersebut akan bingung dan kesulitan dalam memutuskan apa yang
                    harus dilaksanakan. Dalam hal ini, prinsip umum yang seharusnya diterapkan dalam organisasi yaitu
                    ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Teori manajemen yang memusatkan studinya pada aspek manusia dan perlunya memahami
                    manusia merupakan aliran aliran yang memakai disiplin ilmu sosiologi dan psikologi dalam menerapkan
                    teori-teorinya. Teori tersebut merupakan teori ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Prinsip the right man on the right place digunakan dalam memutuskan seseorang
                    ketika akan menduduki suatu jabatan dalam perusahaan atau organisasi. Hal tersebut merupakan
                ...
                <div class="col-sm-12 card">
                    ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Kemampuan personalia, teknis dan konseptual dibawah lower
                            management
                        </label>
                    </div>
                    <div>
                    ...
                    <div>
                        <input id="<?php echo $n ?>C" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>C"> Teknis melebihi lower management dan top management dan tidak
                            ada ketrampilan manusiawi
                        </label>
                    </div>
                    <div>
                        <input id="<?php echo $n ?>D" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
                        <label for="<?php echo $n ?>D"> Konseptual melebihi lower management dan menekankan pada
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Ada 4 unsur penting yang perlu diperhatikan oleh suatu perusahaan ketika
                    memasarkan produknya. Keempat unsur tersebut yang biasanya disebut 4P yaitu ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Kepuasan jangka panjang dapat terpenuhi dengan memperhatikan hal-hal berikut,
                    kecuali ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Perencanaan, pengarahan, pengorganisasian, dan pengendalian atas pengadaan tenaga
                    kerja, pengembangan, kompensasi, pemeliharaan, integrasi, dan PHK (pemutusan hubungan kerja) dengan
                    SDN untuk mencapai sasaran perusahaan merupakan aspek ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Tindakan memantau kinerja atau membandingkan hasil-hasil dengan tujuan, serta
                    tindakan mengadakan perbaikan, serta penafsiran umpan balik kinerja sebagai dasar tindakan
                    konstruktif dan perbaikan jika dipandang perlu, adalah pengertian dari fungsi manajemen ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Organizing
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Menentukan sumber dana yang dibutuhkan, penyusunan anggaran pengeluaran, serta
                    melakukan pengawasan terhadap penggunaan keuangan, merupakan proses yang dijalani oleh manajemen ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Tingkat manajemen yang bertugas memimpin dan mengawasi tenaga-tenaga operasional
                    adalah ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Planning, Organizing, Motivating, Controlling, Evaluating merupakan fungsi
                    manajemen menurut ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Penentuan tujuan yang jelas, pembagian kerja, pelimpahan wewenang, kesatuan
                    komando, rentangan kekuasaan merupakan prinsip-prinsip dari ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, false)">
                        <label for="<?php echo $n ?>A">Directing
                ...
                <div class="col-sm-12 card">
                    <?php $n= $n + 1; ?>
                    <?php echo $n ?>. Dapat menjalani hubungan baik antar anggota organisasi, struktur anggota dapat
                    mengetahui tugas, kewajiban dan tanggung jawabnya, spesialisasi dalam melakukan tugas. Merupakan
                    manfaat ...
                    <div>
                        <input id="<?php echo $n ?>A" type="radio" name="<?php echo $n ?>"
                            onclick="check(<?php echo $n ?>, true)">
